    ...
    <div className="max-w-7xl mx-auto px-6 py-12 animate-in fade-in duration-700">
      ...
      <div className="grid lg:grid-cols-4 gap-6 mb-12">
        {[
          ...
          <div
            key={stat.label}
            className="bg-surface-dark border border-white/5 p-8 rounded-2xl hover:border-primary/30 transition-all group"
          >
      ...
      <div className="grid lg:grid-cols-3 gap-8">
            ...
            {[
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <span
                    className={`text-[10px] font-black uppercase tracking-widest px-2 py-0.5 rounded ${order.status === "Shipped" ? "bg-primary/10 text-primary" : "bg-emerald-500/10 text-emerald-400"}`}
                  >
                    {order.status}
                  </span>
                </div>
        ...
        <div className="bg-gradient-to-br from-primary to-secondary p-8 rounded-3xl flex flex-col justify-between relative overflow-hidden group">
          ...
          <div>
            <h3 className="text-3xl font-black text-background-dark uppercase italic leading-none mb-4">
              Nexus Elite
            </h3>
            <p className="text-background-dark/80 font-bold leading-relaxed mb-8">
              Unlock free same-day shipping and early access to ultra-limited
              drops.
            </p>
          </div>
